...
| [cluster-provider-template](https://github.com/openmcp-project/cluster-provider-template)                 | [@christophrj](https://github.com/christophrj)                                            | Template for building OpenControlPlane Cluster Providers                                                |
...
| [service-provider-metrics-operator](https://github.com/openmcp-project/service-provider-metrics-operator) | [@AndresNico](https://github.com/AndresNico) (@MichaelSp)(https://github.com/MichaelSp)   | Manages the lifecycle of Metrics Operator instances                                                     |
